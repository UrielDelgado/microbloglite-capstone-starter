...
fetch("http://microbloglite.us-east-2.elasticbeanstalk.com/api/posts?limit=10&offset=0", requestOptions)
...
function showpost(postData) {
  ...
  Post.innerHTML = '';  // Clear the existing posts
      ...
      Post.innerHTML += `
          <div class="row mb-4 justify-content-center">
              <div class="col-sm-11 col-md-8 col-lg-8 col-xl-4 mt-3">
                  <div class="card">
                      <h2 class="mountain-name card-title text-center pt-4">${post.username}</h2>
                      <hr class="w-100">
                      <div class="card-body pt-0">
                          <h4 class="mountain-desc card-text">${post.text}</h4>
                          <hr class="w-100">
                          <p class="card-footer"><strong>Posted on:</strong> ${post.createdAt}</p>
                          <div class="like-dislike-container">              
                              <div class="icons-box">
                                  <div class="icons">
                                      <label class="btn-label" for="like-checkbox-${post.id}">
                                          <span class="like-text-content">123</span>
                                          <input class="input-box" id="like-checkbox-${post.id}" type="checkbox">
                                  ...
                                  <div class="icons">
                                      <label class="btn-label" for="dislike-checkbox-${post.id}">
                                          <input class="input-box" id="dislike-checkbox-${post.id}" type="checkbox">
                                          <div class="fireworks">
...
// "createdAt":"2024-06-25T15:58:04.789Z",
// "likes":[]},
